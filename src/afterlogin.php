...
<section id="showcase" class="bg-dark">
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <a href="#myCarousel" class="carousel-control-next pb-5" data-slide="next">
      ...
      <!-- Search Box -->
<section id="searchbar" class="py-5  text-dark text-center">
    <div class="container">
      <div class="row">
        <div class="col">
          <h2 class="text-info">SEARCH-BOX</h2>
          <form action="searchpage.php" method="POST" class="form-inline justify-content-center">
            <label for="destination"class="sr-only">Destination</label>
           <input type="text"class="form-control m-2 border-info" name="des"  id="destination" placeholder="Enter destination">
           <label for="check-in"class="sr-only">Check-in</label>
           <input type="date"class="form-control m-2 border-info" placeholder="Check-in-date" name="cd"  id="cd" >
           <label for="check-out"class="sr-only" >Check-out</label>
           <input type="date"class="form-control m-2 border-info" placeholder="Check-out-date" name="co" id="co" >
           <label for="room" class="sr-only">Room</label>
           <select  id="room"class="form-control m-2 border-info" name="room" placeholder="Room">
             <option>One-person room</option>
             <option>Two-person room</option>
             <option>Family rooms</option>
             <option>Multiple rooms</option>
           </select>
           <input type="submit" value="submit" name="submit" id="sub" class="btn btn-primary m-2 text-dark btn-outline-info">
          </form>
        </div>
      </div>
    </div>
