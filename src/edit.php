<?php
  ...
  $conn=mysqli_connect($_ENV['MYSQL_HOST'],$_ENV['MYSQL_USER'],$_ENV['MYSQL_PASSWORD'],$_ENV['MYSQL_DATABASE']);
   ...
   $sql = "SELECT * FROM room WHERE room_id='".$sid."'";
                 ...
                 <div class="col-md-5">
                     <div class="card my-2 ml-5 pb-2 vg">
                         ...
                         <div class="card-body">
                          ...
                          <form class="form-horizontal text-light" method="POST" action="updatedata.php" enctype="multipart/form-data">

                                 <div class="form-group">
                                     <label for="name" class="cols-sm-2 control-label pl-4" >Hotel Name</label>
                                     <div class="cols-sm-10">
                                         <div class="input-group">
                                             <span class="input-group-addon mr-2"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                                             <input required type="text" class="form-control" name="name" id="name" value=<?php echo $data['room_name']; ?> />
                                         </div>
                                     </div>
                                 </div>
                                 <div class="form-group">
                                     ...
                                     <div class="cols-sm-10">
                                         <div class="input-group">
                                             ...
                                             <input required type="text" class="form-control" name="type" id="type" value=<?php echo $data['roomtype']; ?> />
                                         </div>
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group">
                                     ...
                                     <div class="cols-sm-10">
                                         <div class="input-group">
                                             <span class="input-group-addon mr-2"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                                             <input required type="text" class="form-control" name="person" id="person" value=<?php echo $data['person']; ?> />
                                         </div>
                                     </div>
                                 </div>
                                 <div class="form-group">
                                 ...
                                 <div class="form-group mb-2 ">
                                     <input  type="hidden" class="form-control" name="sid"  value=<?php echo $data['room_id']; ?> />
