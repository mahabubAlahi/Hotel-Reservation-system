...
<body>
  ...
  <h1 class="text-center">Search Result</h1>
         ...
         <?php while($data=mysqli_fetch_assoc($run)){ ?>
        	<div class="card-group">
               ...
               <img class="card-img-top" style="height: 360px; object-fit:cover;" src="img/<?php echo $data['img']; ?>" />
                 ...
                 <a href="deleteform.php?sid=<?php echo $data['room_id']; ?>" class="btn btn-primary btn-block">Delete</a>
    ...
    <footer id="copyright" class="py-3 text-light text-center bg-dark">
      <div class="container">
        <div class="row">
          <div class="col">
            <p class="lead mb-0">Copyright 2019 © Mahabub Alahi</p>
          </div>
        </div>
      </div>
    </footer>
